...
class Metaclass_GetMetadata_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lidar_msgs.msg import Metadata
...
class GetMetadata_Response(metaclass=Metaclass_GetMetadata_Response):
    ...
    _fields_and_field_types = {
        'metadata': 'lidar_msgs/Metadata',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['lidar_msgs', 'msg'], 'Metadata'),  # noqa: E501
    )
...
class Metaclass_GetMetadata(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lidar_msgs.srv import _get_metadata
...
class GetMetadata(metaclass=Metaclass_GetMetadata):
    from lidar_msgs.srv._get_metadata import GetMetadata_Request as Request
    from lidar_msgs.srv._get_metadata import GetMetadata_Response as Response
