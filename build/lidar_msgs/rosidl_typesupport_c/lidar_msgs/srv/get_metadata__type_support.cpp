...
static const _GetMetadata_Request_type_support_symbol_names_t _GetMetadata_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_msgs, srv, GetMetadata_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_msgs, srv, GetMetadata_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_msgs, srv, GetMetadata_Request)() {
  return &::lidar_msgs::srv::rosidl_typesupport_c::GetMetadata_Request_message_type_support_handle;
}
...
static const _GetMetadata_Response_type_support_symbol_names_t _GetMetadata_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_msgs, srv, GetMetadata_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_msgs, srv, GetMetadata_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_msgs, srv, GetMetadata_Response)() {
  return &::lidar_msgs::srv::rosidl_typesupport_c::GetMetadata_Response_message_type_support_handle;
}
...
static const _GetMetadata_type_support_symbol_names_t _GetMetadata_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_msgs, srv, GetMetadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_msgs, srv, GetMetadata)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lidar_msgs, srv, GetMetadata)() {
  return &::lidar_msgs::srv::rosidl_typesupport_c::GetMetadata_service_type_support_handle;
}
