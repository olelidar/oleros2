#ifndef ROS2_lidar__STRING_UTILS_HPP_
#define ROS2_lidar__STRING_UTILS_HPP_
...
{
  return ros2_lidar::ltrim(ros2_lidar::rtrim(str, white), white);
}
...
#endif  // ROS2_lidar__STRING_UTILS_HPP_
